  ...
  >
    ...
    >
      ...
      <n-form
        ...
        :rules="rules"
      >
        <n-form-item path="title" style="width: 40%">
        ...
        <n-form-item path="price" style="width: 25%">
        ...
        <n-form-item path="stock" style="width: 25%">
        ...
        <div class="describe" path="description">
        ...
        <div
          path="cover"
          style="width: 100%; display: flex; margin: 20px 0 20px"
        >
        ...
        <n-row
          style="width: 720px; position: absolute; bottom: 20px"
          :gutter="[0, 24]"
        >
          <n-col :span="24">
            <div
              ...
              "
            >
              <n-button round type="primary" @click="userSubmit">
                添加
              </n-button>
            </div>
          </n-col>
...
import { changeGood, getGoodInfo } from "@/api/goods";
...
const backKey = (key) => {
  ...
  // console.log(model.value.cover);
};
const backContent = (details) => {
  model.value.details = details;
  // console.log(model.value.details);
};
...
const userSubmit = (e) => {
  ...
  formRef.value.validate((errors) => {
    if (errors) {
      ...
      changeGood(props.good_id, model.value).then(() => {
